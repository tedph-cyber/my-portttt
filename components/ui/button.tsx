  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-[hsl(var(--background))] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "cyber-gradient text-[hsl(var(--primary-foreground))] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl font-semibold",
        cyber:
          "bg-[hsl(var(--cyber-primary))] text-[hsl(var(--primary-foreground))] hover:bg-[hsl(var(--cyber-secondary))] transition-all duration-300 glow-effect",
        music:
          "music-gradient text-[hsl(var(--primary-foreground))] hover:scale-105 transition-all duration-300 shadow-lg",
      },
      size: {
